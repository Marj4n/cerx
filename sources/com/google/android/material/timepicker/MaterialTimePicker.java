...
public final class MaterialTimePicker extends DialogFragment {
    ...
    private static final Pair<Integer, Integer> CLOCK_BUTTON_DATA = new Pair<>(Integer.valueOf(R.drawable.ic_clock_black_24dp), Integer.valueOf(R.string.material_timepicker_clock_mode_description));
    private static final Pair<Integer, Integer> KEYBOARD_BUTTON_DATA = new Pair<>(Integer.valueOf(R.drawable.ic_keyboard_black_24dp), Integer.valueOf(R.string.material_timepicker_text_input_mode_description));
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.textInputView = (LinearLayout) viewGroup2.findViewById(R.id.material_textinput_timepicker);
