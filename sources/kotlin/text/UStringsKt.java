...
public final class UStringsKt {
    ...
    public static final String m1269toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1271toStringolVBNx4(short s, int i) {
    ...
    public static final String m1270toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1268toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int i) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m107constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m33boximpl(UByte.m39constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int i) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m107constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m269boximpl(UShort.m275constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int i) {
        ...
        int m107constructorimpl = UInt.m107constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m336uintDivideJ1ME1BU(-1, m107constructorimpl);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int m107constructorimpl2 = UInt.m107constructorimpl(i2 * m107constructorimpl);
            int m107constructorimpl3 = UInt.m107constructorimpl(UInt.m107constructorimpl(digitOf) + m107constructorimpl2);
            if (UnsignedKt.uintCompare(m107constructorimpl3, m107constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = m107constructorimpl3;
        }
        return UInt.m101boximpl(i2);
    }
    ...
    public static final ULong toULongOrNull(String toULongOrNull, int i) {
        ...
        long m177constructorimpl = ULong.m177constructorimpl(i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m338ulongDivideeb3DHEI(j, m177constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long m177constructorimpl2 = ULong.m177constructorimpl(j2 * m177constructorimpl);
            long m177constructorimpl3 = ULong.m177constructorimpl(ULong.m177constructorimpl(UInt.m107constructorimpl(r15) & 4294967295L) + m177constructorimpl2);
            if (UnsignedKt.ulongCompare(m177constructorimpl3, m177constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = m177constructorimpl3;
            j = -1;
        }
        return ULong.m171boximpl(j2);
    }
}
