...
public final class DurationKt {
    ...
    private static final double m1326timesmvk6XK0(int i, double d) {
        return Duration.m1306timesUwyO8pc(d, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m1325timeskIfJnKk(double d, double d2) {
        return Duration.m1305timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        return Duration.m1279constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
