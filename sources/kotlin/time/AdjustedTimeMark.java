...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double mo1272elapsedNowUwyO8pc() {
        return Duration.m1302minusLRDsOJo(this.mark.mo1272elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1273plusLRDsOJo(double duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1303plusLRDsOJo(this.adjustment, duration), null);
    }
}
