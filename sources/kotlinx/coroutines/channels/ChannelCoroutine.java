...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    static /* synthetic */ Object m1346receiveOrClosedZYPwvRU$suspendImpl(ChannelCoroutine channelCoroutine, Continuation continuation) {
        return channelCoroutine._channel.mo1345receiveOrClosedZYPwvRU(continuation);
    }
    ...
    public Object mo1345receiveOrClosedZYPwvRU(Continuation<? super ValueOrClosed<? extends E>> continuation) {
        return m1346receiveOrClosedZYPwvRU$suspendImpl(this, continuation);
    }
