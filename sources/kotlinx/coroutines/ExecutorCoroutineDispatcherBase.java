...
public abstract class ExecutorCoroutineDispatcherBase extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1377scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        ...
        if (scheduleBlock != null) {
            ...
            DefaultExecutor.INSTANCE.mo1377scheduleResumeAfterDelay(timeMillis, continuation);
        }
    }
