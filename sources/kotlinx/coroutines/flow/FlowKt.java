...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1360catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m1365catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m1361debounce8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1363debounce8GFy2Ro(flow, d);
    }
    ...
    public static final /* synthetic */ <T> Flow<T> onCompletion(Flow<? extends T> flow, Function2<? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function2) {
        Flow<T> onCompletion;
        onCompletion = onCompletion(flow, new FlowKt__EmittersKt$onCompletion$2(function2, null));
        return onCompletion;
    }
    ...
    public static final <T> Flow<T> m1362sample8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1364sample8GFy2Ro(flow, d);
    }
