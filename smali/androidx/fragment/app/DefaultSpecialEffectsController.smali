...
.method private startAnimations(Ljava/util/List;ZLjava/util/Map;)V
    ...
    .line 137
    invoke-virtual {v4}, Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;->isVisibilityUnchanged()Z
    ...
    .line 148
    :cond_1
    iget-object v7, v7, Landroidx/fragment/app/FragmentAnim$AnimationOrAnimator;->animator:Landroid/animation/Animator;
    ...
    .line 170
    iget-object v5, v9, Landroidx/fragment/app/Fragment;->mView:Landroid/view/View;

    .line 171
    invoke-virtual {v0, v5}, Landroid/view/ViewGroup;->startViewTransition(Landroid/view/View;)V

    .line 172
    new-instance v6, Landroidx/fragment/app/DefaultSpecialEffectsController$2;

    invoke-direct {v6, p0, v0, v5, v4}, Landroidx/fragment/app/DefaultSpecialEffectsController$2;-><init>(Landroidx/fragment/app/DefaultSpecialEffectsController;Landroid/view/ViewGroup;Landroid/view/View;Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;)V
    ...
    invoke-direct {v5, p0, v7}, Landroidx/fragment/app/DefaultSpecialEffectsController$3;-><init>(Landroidx/fragment/app/DefaultSpecialEffectsController;Landroid/animation/Animator;)V
    ...
    check-cast p3, Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;

    .line 194
    invoke-virtual {p3}, Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;->getOperation()Landroidx/fragment/app/SpecialEffectsController$Operation;
    ...
    .line 201
    :cond_6
    invoke-virtual {p3}, Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;->completeSpecialEffect()V
    ...
    .line 217
    invoke-virtual {p3, v1}, Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;->getAnimation(Landroid/content/Context;)Landroidx/fragment/app/FragmentAnim$AnimationOrAnimator;
    ...
    check-cast v7, Landroidx/fragment/app/FragmentAnim$AnimationOrAnimator;
    ...
    invoke-direct {v2, v7, v0, v4}, Landroidx/fragment/app/FragmentAnim$EndViewTransitionAnimation;-><init>(Landroid/view/animation/Animation;Landroid/view/ViewGroup;Landroid/view/View;)V

    .line 231
    new-instance v7, Landroidx/fragment/app/DefaultSpecialEffectsController$4;

    invoke-direct {v7, p0, v0, v4, p3}, Landroidx/fragment/app/DefaultSpecialEffectsController$4;-><init>(Landroidx/fragment/app/DefaultSpecialEffectsController;Landroid/view/ViewGroup;Landroid/view/View;Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;)V
    ...
    .line 257
    :goto_2
    invoke-virtual {p3}, Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;->getSignal()Landroidx/core/os/CancellationSignal;

    move-result-object p3

    .line 258
    new-instance v2, Landroidx/fragment/app/DefaultSpecialEffectsController$5;

    invoke-direct {v2, p0, v4}, Landroidx/fragment/app/DefaultSpecialEffectsController$5;-><init>(Landroidx/fragment/app/DefaultSpecialEffectsController;Landroid/view/View;)V

    invoke-virtual {p3, v2}, Landroidx/core/os/CancellationSignal;->setOnCancelListener(Landroidx/core/os/CancellationSignal$OnCancelListener;)V
...
.method executeOperations(Ljava/util/List;Z)V
    ...
    .line 120
    invoke-direct {p0, v0, p2, p1}, Landroidx/fragment/app/DefaultSpecialEffectsController;->startAnimations(Ljava/util/List;ZLjava/util/Map;)V
